...
const inputImpedanciaMotor3 = document.querySelector("#impedancia-motor-3");
...
const spanCorrenteNoMotor3 = document.querySelector(".correnteNoMotor3");
...
const spanPotenciaDoMotor3 = document.querySelector(".potenciaDoMotor3");
...
inputImpedanciaMotor3.addEventListener("keyup", () => {
    impedanciaMotor3 = inputImpedanciaMotor3.value;
    atualizarDados()
})
...
const calcularImpedanciaEquivalenteDosMotores = () => {
    ...
    const valoresImpMotor3 = impedanciaMotor3.split("<");
    ...
    valoresImpMotor3[0] = parseFloat(valoresImpMotor3[0]);
    valoresImpMotor3[1] = parseFloat(valoresImpMotor3[1]);
    ...
    const imp3Ret = converterParaRetangular(valoresImpMotor3[0], valoresImpMotor3[1]);
    
    const somaImpedanciasRet1 = [(imp1Ret[0] + imp2Ret[0]), (imp1Ret[1] + imp2Ret[1])];
    const somaImpedanciasPol1 = converterParaPolar(somaImpedanciasRet1[0], somaImpedanciasRet1[1]);
    const multiplicacaoImpedancias1 = [(valoresImpMotor1[0] * valoresImpMotor2[0]), (valoresImpMotor1[1] + valoresImpMotor2[1])];

    const impedanciaEquivalente1 = [(multiplicacaoImpedancias1[0] / somaImpedanciasPol1[0]), (multiplicacaoImpedancias1[1] - somaImpedanciasPol1[1])];
    const impedanciaEquivalenteRet1 = converterParaRetangular(impedanciaEquivalente1[0], impedanciaEquivalente1[1]);

    const somaImpedanciasRet2 = [(impedanciaEquivalenteRet1[0] + imp3Ret[0]), (impedanciaEquivalenteRet1[1] + imp3Ret[1])];
    const somaImpedanciasPol2 = converterParaPolar(somaImpedanciasRet2[0], somaImpedanciasRet2[1]);
    const multiplicacaoImpedancias2 = [(impedanciaEquivalente1[0] * valoresImpMotor3[0]), (impedanciaEquivalente1[1] + valoresImpMotor3[1])];

    const impedanciaEquivalenteFinal = [(multiplicacaoImpedancias2[0] / somaImpedanciasPol2[0]), (multiplicacaoImpedancias2[1] - somaImpedanciasPol2[1])];

    return impedanciaEquivalenteFinal;
}
...
const atualizarDados = () => {
    ...
    const correnteMotor3 = calcularCorrenteNoMotor(impedanciaMotor3);
    ...
    spanCorrenteNoMotor3.innerHTML = `${correnteMotor3[0].toFixed(2)}<${correnteMotor3[1].toFixed(2)}° A`;
